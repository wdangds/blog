...
This definition is intentionally broad. A data scientist may use [regression models](chapter-4.qmd), [neural networks](chapter-8.qmd), visualization, databases, simulation, causal reasoning, or cloud-based pipelines. What unifies these activities is the goal: to convert data into knowledge that can be evaluated, communicated, and used.
...
- Feature selection
- Regularization
- [Principal Component Analysis](chapter-10.qmd)
- Autoencoders
...
A retail store may use [clustering](chapter-11.qmd) to group customers based on purchase history. One cluster may contain frequent high-value buyers, another may contain seasonal buyers, and another may contain discount-driven buyers. The company can then design different marketing strategies for each group.
...
- [Logistic regression](chapter-4.qmd#logistic-regression)
- [Decision tree](chapter-5.qmd)
- [Random forest](chapter-5.qmd#bagging-and-random-forests)
