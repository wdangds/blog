...
This is why trees do not require feature scaling in the same way that KNN, K-means, or [gradient-based regression models](chapter-4.qmd#gradient-descent-for-regression) often do. Scaling is often unnecessary for tree split rules because trees depend on order.
